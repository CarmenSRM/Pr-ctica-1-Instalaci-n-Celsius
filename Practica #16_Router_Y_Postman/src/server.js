...
let studentRoute = require('./routes/student'); //Se incluye el router que viene de student. 
...
app.use(studentRoute);//Se habilita el usar las rutas del archivo de student.
